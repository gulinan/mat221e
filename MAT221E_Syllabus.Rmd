...
| **Week**  | **Topic**                  |  <a href="https://github.com/"><i class="fab fa-github"></i></a> | History| <br>Additional Documents|
| :-----:   |:-------------------------|:---:|:---:|:---:|
...
| 6 | Definition of Expectation, Special expectations: mean and variance. Special discrete distributions: Bernoulli, and Binomial distributions.  | [🔗](https://colab.research.google.com/drive/1nDe0O7LgRs9OKHjESBWjzdeiVdxSMuED?usp=sharing)| [Jacob (James) Bernoulli](https://en.wikipedia.org/wiki/Jacob_Bernoulli) | |
| 7 | Special discrete distributions: Poisson, Geometric, Negative Binomial, Hypergeometric, and discrete uniform distributions. **Quiz I during lecture hour.** |[🔗](https://colab.research.google.com/drive/1PvczfQSX8_YuyLqjqIFrOg0b3yJtVErZ?usp=sharing)| [Siméon Denis Poisson](https://en.wikipedia.org/wiki/Sim%C3%A9on_Denis_Poisson)| [Quiz I](docs/Quiz_I.pdf) |
| 8 | ITU Fall Break.  | | |
