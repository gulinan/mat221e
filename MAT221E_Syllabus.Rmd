...
| 5         | Random variables, distributions and probability mass functions, cumulative distribution function. Definition of Expectation, Special expectations: mean and variance.  | [🔗](https://colab.research.google.com/drive/1G4hPDOpq_9YRMIyST8sr_UMBLF6ythhC?usp=sharing) |
| 6 | Bernoulli, Binomial, Hypergeometric, and discrete uniform distributions.  | |
| 7 | Geometric, Negative Binomial, and Poisson distributions. **Quiz I during lecture hour.** | |
| 8 | ITU Fall Break.  | |
