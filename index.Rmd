...
| 11 | Special continuous distributions: Uniform, Gamma, Exponential, and Normal distributions.| [Abraham de Moivre](https://en.wikipedia.org/wiki/Abraham_de_Moivre), [Carl Friedrich Gauss](https://en.wikipedia.org/wiki/Carl_Friedrich_Gauss)| | [Random Number Generation](https://en.wikipedia.org/wiki/Random_number_generation)|
| 12 | Joint distributions: Joint, marginal, and conditional distributions.  | | | |
| 12.5 | Conditional expectation. Conditional variance. Covariance and correlation. Multinomial distribution. Multivariate Normal distribution.  **Additional class which is missed due to Midterm**. | | | |
| 13 | Transformations: Change of variables, convolutions, Beta distribution.| | | |
| 14 | Moments: Summaries of a distribution, sample moments, moment generating functions. | | | |
